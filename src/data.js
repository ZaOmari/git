// Seed data, stage templates and category palette — ported verbatim from the
// СтройКонтроль design so the implementation stays pixel- and number-faithful.
  ...
  return [
    {
      ...
      expenses: [
        ...
        { id: 'e5', date: '28.05', text: 'Доставка ЖБИ', amount: 18500, cat: 'Логистика', paid: true, who: 'Т', split: true },
      ],
      crews: [
    ...
    },
    {
      ...
      type: 'spec', price: null, base: 1660000, stageIndex: 3,
      expenses: [
        ...
        { id: 'e8', date: '24.05', text: 'Доставка ЖБИ', amount: 18500, cat: 'Логистика', paid: true, who: 'Т', split: true },
      ],
    ...
    },
    {
      ...
      crews: [
        ...
        { id: 'c5', work: 'Электромонтаж', agreed: 320000, payouts: [{ d: '02.06', a: 200000 }] },
      ],
